...
<body class="antialiased">
    <nav class="navbar navbar-light bg-primary d-flex justify-content-center">
        <a class="navbar-brand text-white" href="/">Booking Badmintons</a>
    </nav>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('bukti_bayar.store', $booking->id) }}" enctype="multipart/form-data">
                                            @csrf

                                            <div class="row mb-3">
                                                <label for="bukti_pembayaran" class="col-md-4 col-form-label text-md-end">{{ __('Bukti Pembayaran') }}</label>
