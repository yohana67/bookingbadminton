<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseBook" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item {{ request()->is('admin/arenas') || request()->is('admin/arenas/*') ? 'active' : '' }}" href="{{ route('admin.arenas.index') }}"> <i class="fa fa-briefcase mr-2"></i> {{ __('Lapangan') }}</a>
