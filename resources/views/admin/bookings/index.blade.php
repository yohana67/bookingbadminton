                    ...
                    <table class="table table-bordered table-striped table-hover datatable datatable-booking"
                        ...
                        <tbody>
                            @forelse($bookings as $booking)
                                <tr data-entry-id="{{ $booking->id }}">
                                    ...
                                    @php
                                        $hour =
                                            date(
                                                'h',
                                                strtotime(Carbon\Carbon::parse($booking->time_to)->format('H:i:s')),
                                            ) -
                                            date(
                                                'h',
                                                strtotime(Carbon\Carbon::parse($booking->time_from)->format('H:i:s')),
                                            );
                                    @endphp
                                    <td>{{ $hour }} Jam</td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <!-- Tombol untuk membuka modals -->
                                            <button type="button" class="btn btn-warning" data-toggle="modal"
                                                data-target="#buktiPembayaranModal{{ $booking->id }}">
                                                <i class="fa fa-eye"></i>
                                            </button>
                                ...
                                <!-- Modals untuk menampilkan bukti pembayaran -->
                                <div class="modal fade" id="buktiPembayaranModal{{ $booking->id }}" tabindex="-1"
                                    role="dialog" aria-labelledby="buktiPembayaranModalLabel{{ $booking->id }}"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="buktiPembayaranModalLabel{{ $booking->id }}">
                                                    Bukti Pembayaran</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                @if ($booking->bukti_pembayaran)
                                                    <img src="{{ asset('storage/img/' . $booking->bukti_pembayaran) }}" alt="Bukti Pembayaran" class="img-fluid">
                                                @else
